...
Narrow criteria: reject hardcoded/shared staging data; distinguish a factory, fixture builder, and payload builder; require test-owned synthetic data and state missing project capabilities as `Not Provided`. Data authorship does not establish Product Behavior; missing project capabilities are `Not Provided`.
...
Narrow criteria: choose reset, transaction, focused fixture, sandbox, or another strategy conditionally; do not make one mechanism universal; require each test to own mutable data and explain cleanup/parallel assumptions. Data authorship does not establish Product Behavior; missing project capabilities are `Not Provided`.
...
Narrow criteria: use deterministic scoped sequences or controlled seeds for unique values; capture generated values instead of asserting random literals; do not use uncontrolled time or randomness to hide collisions. Data authorship does not establish Product Behavior; missing project capabilities are `Not Provided`.
...
Narrow criteria: use disposable synthetic data, controlled doubles, sandbox boundaries, and approved limited reproduction; do not repeat destructive live actions; state the unexecuted or blocked scope and keep Product Behavior separate. Data authorship does not establish Product Behavior; missing project capabilities are `Not Provided`.
